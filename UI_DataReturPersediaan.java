 ...
 * @author Asus
 */
public class UI_DataReturPersediaan extends javax.swing.JFrame {

    /**
     * Creates new form UI_DataPersediaan
     */
    public UI_DataReturPersediaan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TblSuplier.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Retur", "Tanggal", "Suplier", "No Faktur", "Keterangan"
            }
        ) {
        ...
        jLabel12.setText("DATA RETUR PERSEDIAAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_DataReturPersediaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_DataReturPersediaan().setVisible(true);
            }
        });
    }
